    ...
    <Layout>
      ...
      <Box justify='center' align='center' className='BoxContainer'>
        <Box className='DetailHeader' pad='medium'>
          <h1>비지니스 아이디어</h1>
          <div>
            <h2>콘텐츠를 상품으로 만드는 법.</h2>
            <h2> 나만의 콘텐츠, 나만의 비지니스 어떻게 준비할 수 있을까요?</h2>
          </div>
          <hr />
        </Box>
        ...
        <Box fill className='DetailContainer'>
          ...
          >
            ...
            <div className='Detail-TextBox'>
              <div>
                <h3>
                  콘텐츠가 사업과 이어질 수 있는 연결고리를 먼저 설계해보세요.
                </h3>
                <p>
                  내가 좋아서 만드는 콘텐츠로 돈을 벌 수 있는 있는 방법은
                  없을까요? 콘텐츠를 만들기 전, 장기적인 계획을 세워볼 수
                  있습니다.
                </p>
              </div>
              <div>
                <h3>
                  내가 만들어온 콘텐츠를 바탕으로 사업 아이템을 만들어보세요.
                </h3>
                <p>
                  블로그, 유튜브 등 콘텐츠 플랫폼에 이미 상당한 양의 콘텐츠를
                  쌓아만 두고 있나요? 수익화할 수 있는 새로운 경로를
                  모색해보세요.
                </p>
              </div>
            </div>
          ...
          <Box className='Detail3' justify='center' align='center'>
            ...
            >
              ...
              <div>
                ...
                <p>
                  여러 아이디어 중 실제 사업으로 연계할 수 있는 아이템이 뭔지
                  생각해보세요.
                </p>
              </div>
              <div>
                ...
                <p>
                  비지니스 관점에서 내 콘텐츠의 방향과 지향점을 살펴보세요.{" "}
                </p>
              </div>
            </Box>
